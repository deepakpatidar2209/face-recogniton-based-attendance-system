...
#contact
def contact():
    mess._show(title="Contact Me",message="If you find anything weird or you need any help contact me on 'deepakptdr2209@gmail.com'")

#about
def about():
    mess._show(title="About",message="This Attendance System is designed by Deepak Patidar,Anurag Yadav,Ayushman Raghuwanshi,Deepesh Tolani Suvariya")
...
window.configure(background='#ccffff')
...
#main window------------------------------------------------
message3 = tkinter.Label(window, text="Face Recognition Based Attendance System" ,fg="black",bg="#00e6e6" ,width=60 ,height=1,font=('times', 29, ' bold '))
...
clearButton = tkinter.Button(frame1, text="Clear", command=clear, fg="white", bg="#f2150a", width=11, activebackground = "white", font=('times', 12, ' bold '))
clearButton.place(x=55, y=230,relwidth=0.29)

takeImg = tkinter.Button(frame1, text="Take Images", command=TakeImages, fg="black", bg="#91f50f", width=34, height=1, activebackground = "white", font=('times', 16, ' bold '))
takeImg.place(x=30, y=350,relwidth=0.89)

trainImg = tkinter.Button(frame1, text="Save Profile", command=psw, fg="black", bg="#91f50f", width=34, height=1, activebackground = "white", font=('times', 16, ' bold '))
trainImg.place(x=30, y=430,relwidth=0.89)

trackImg = tkinter.Button(frame2, text="Take Attendance", command=TrackImages, fg="black", bg="#91f50f", height=1, activebackground = "white" ,font=('times', 16, ' bold '))
trackImg.place(x=30,y=60,relwidth=0.89)

quitWindow = tkinter.Button(frame2, text="Quit", command=window.destroy, fg="white", bg="#f2150a", width=35, height=1, activebackground = "white", font=('times', 16, ' bold '))
